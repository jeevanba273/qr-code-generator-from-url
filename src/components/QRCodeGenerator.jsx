            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  className="w-full text-lg pl-4 pr-10 py-3 backdrop-blur-sm bg-white/20 border-white/20 text-white placeholder-white/60 focus:ring-2 focus:ring-violet-400 focus:border-transparent transition-all"
                />
